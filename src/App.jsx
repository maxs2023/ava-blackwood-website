        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex gap-2">
            <input
              ...
              required
              className="flex-1 px-4 py-3 rounded-lg text-gray-900 border-1 focus:ring-2 focus:ring-accent"
...
function App() {
  ...
  const BlogPage = () => {
    ...
    // --- NEW: Define custom components for Portable Text ---
    const ptComponents = {
      block: {
    ...
    useEffect(() => {
      // The query now includes the author's name and main image URL for display
  ...
  /*  const BlogPage = () => {
    ...
    useEffect(() => {
      // The query now includes the author's name for display
      const query = `*[_type == "post" && defined(slug.current)] | order(publishedAt desc) {
        ...,
        author->{name}
      }`;
        ...
        <div className="min-h-screen py-12 px-4 bg-muted">
          <div className="max-w-3xl mx-auto">
            ...
            <Card className="bg-white">
              ...
              <CardContent>
                <div className="blog-content text-lg text-gray-700 leading-relaxed space-y-4">
                  {/* --- UPDATED: Pass the custom components to PortableText --- */}
                  <PortableText value={selectedPost.body} components={ptComponents} />
                </div>
              </CardContent>
            </Card>
    ...
    <footer className="burgundy-section py-16 px-4 mt-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border-t border-gray-600 pt-8 text-center text-gray-300">
          <p>&copy; 2025 Ava Blackwood. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
