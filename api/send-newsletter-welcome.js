        ...
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; padding: 20px; background: #F8F6F0;">
          ...
          <div style="padding: 30px; background: white;">
            ...
            <div style="background: #f8f6f0; padding: 20px; border-left: 4px solid #D4AF37; margin: 20px 0;">
              <p style="margin: 0; font-style: italic;">"In the shadows of ancient libraries and ivy-covered halls, love finds its most passionate expression."</p>
            </div>
            
            <p style="margin: 0 0 15px 0; line-height: 1.6;">Explore my latest books and dive into worlds where academic intrigue meets forbidden romance.</p>
